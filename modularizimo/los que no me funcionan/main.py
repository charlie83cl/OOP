...
producto1 = Product(1001,"te negro",500,"Infusión")
producto2 = Product(1002,"cafe",1500,"Infusión")
producto3 = Product(1003,"chocolate",700,"Alimento")
producto4 = Product(1004,"trigo", 1000, "Alimento")
producto5 = Product(1005,"mate", 900, "Bebestible")
